...
public class captura_alumnos extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         ...
         String telc = jTextField5.getText();
         String dir = jTextField6.getText();
         String sexo = (String)jComboBox1.getSelectedItem();
         String grupo = jTextField7.getText();
         
        String sql = "INSERT INTO Alumno(CURP,Ap_paterno,Ap_materno,Nombre,direccion,tel_casa,sexo,grupo) VALUES (?,?,?,?,?,?,?,?)";
        try {
            ...
            Logger.getLogger(captura_alumnos.class.getName()).log(Level.SEVERE, null, ex);
        }
